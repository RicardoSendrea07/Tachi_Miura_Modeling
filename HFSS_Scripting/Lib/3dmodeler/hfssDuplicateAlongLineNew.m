...
% ----------------------------------------------------------------------------
function hfssDuplicateAlongLineNew(fid, ObjectList, dVector, nClones, Units, dupBoundaries)
	...
	fprintf(fid, '"XComponent:=", "%s%s", _\n', dVector(1), Units);
	fprintf(fid, '"YComponent:=", "%s%s", _\n', dVector(2), Units);
	fprintf(fid, '"ZComponent:=", "%s%s", _\n', dVector(3), Units);
